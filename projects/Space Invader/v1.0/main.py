...
#! tutorial ended up in: 1:12:14

import pygame
import random
import math
# mixer handles music in game
...
def player(x,y):
    screen.blit(playerImg,(x,y)) # blit() means 'to draw', so we are basically drawing an image of player to screen
